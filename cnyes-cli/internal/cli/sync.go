...
Exit codes & warnings:
  ...
  cnyes-cli-pp-cli sync

  # Sync specific resources only
  cnyes-cli-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  cnyes-cli-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  cnyes-cli-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  cnyes-cli-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  cnyes-cli-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/cnyes-cli-pp-cli/data.db)")
