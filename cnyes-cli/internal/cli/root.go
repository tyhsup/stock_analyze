...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "cnyes-cli-pp-cli",
		Short: "Manage cnyes-cli resources via the cnyes-cli API",
		Long: `Manage cnyes-cli resources via the cnyes-cli API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'cnyes-cli-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("cnyes-cli-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'cnyes-cli-pp-cli profile list')")
