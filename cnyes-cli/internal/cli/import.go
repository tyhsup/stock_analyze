...
but do not stop the import.`,
  ...
  cnyes-cli-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  cnyes-cli-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | cnyes-cli-pp-cli import <resource> --input -`,
