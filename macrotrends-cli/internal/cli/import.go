...
but do not stop the import.`,
  ...
  macrotrends-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  macrotrends-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | macrotrends-pp-cli import <resource> --input -`,
