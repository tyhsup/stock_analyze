...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "macrotrends-pp-cli",
		Short: "Manage macrotrends resources via the macrotrends API",
		Long: `Manage macrotrends resources via the macrotrends API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'macrotrends-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("macrotrends-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'macrotrends-pp-cli profile list')")
	...
	rootCmd.AddCommand(newMacrotrendsCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("macrotrends-pp-cli %s\n", version)
		},
	}
}
