    ...
    def extract_projection_start(self):
        ...
        mapping = {
            'tw': {
                ...
                'operating_lease_liability': ["租賃負債-流動", "租賃負債-非流動", "流動租賃負債", "非流動租賃負債", "租賃負債", "Operating Lease Liability", "Lease Liabilities"],
                'preferred_stock': ["特別股股本", "特別股", "Preferred Stock"],
                'minority_interest': ["非控制權益", "少數股權", "Minority Interest", "非控制權益（淨利）"],
                'pension_deficit': ["淨確定福利負債-非流動", "淨確定福利負債", "應計退休金負債", "Defined Benefit Obligation"],
            ...
            'us': {
                ...
                'operating_lease_liability': ["OperatingLeaseLiabilityCurrent", "OperatingLeaseLiabilityNoncurrent", "OperatingLeaseLiability", "FinanceLeaseLiabilityCurrent", "FinanceLeaseLiabilityNoncurrent"],
                'preferred_stock': ["PreferredStockValue", "PreferredStockValueOutstanding", "PreferredStockIncludingAdditionalPaidInCapitalNetOfDiscount"],
                'minority_interest': ["MinorityInterest", "MinorityInterestInConsolidatedEntities", "NoncontrollingInterestInConsolidatedEntity"],
                'pension_deficit': ["PensionAndOtherPostretirementDefinedBenefitPlansCurrentLiabilities", "PensionAndOtherPostretirementDefinedBenefitPlansNoncurrentLiabilities", "PensionObligations"],
        ...
        try:
            ...
            return {
                ...
                'operating_lease_liability': get_v_bs(last_bs, m.get('operating_lease_liability', []), 'operating_lease_liability'),
                'preferred_stock': get_v_bs(last_bs, m.get('preferred_stock', []), 'preferred_stock'),
                'minority_interest': get_v_bs(last_bs, m.get('minority_interest', []), 'minority_interest'),
                'pension_deficit': get_v_bs(last_bs, m.get('pension_deficit', []), 'pension_deficit'),
