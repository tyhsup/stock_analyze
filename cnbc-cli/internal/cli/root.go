...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "cnbc-cli-pp-cli",
		Short: "Manage cnbc-cli resources via the cnbc-cli API",
		Long: `Manage cnbc-cli resources via the cnbc-cli API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'cnbc-cli-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("cnbc-cli-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'cnbc-cli-pp-cli profile list')")
	...
	rootCmd.AddCommand(newRsCmd(flags))
	...
	rootCmd.AddCommand(newQuoteHtmlWebservicePromotedCmd(flags))
