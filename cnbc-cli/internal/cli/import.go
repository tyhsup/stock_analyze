...
but do not stop the import.`,
  ...
  cnbc-cli-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  cnbc-cli-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | cnbc-cli-pp-cli import <resource> --input -`,
